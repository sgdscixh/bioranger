...
fields_ <- list(
    Package = "bioranger",
    Version = "1.3.0",
    Title = "A Package for network pharam",
    Description = "用于网络药理学相关分析的工具流程集合.",
    `Authors@R` = person(
        given = "LIU",
        family = "YAN",
        email = "lyfx99@icloud.com",
        role = c("aut", "cre")
    )
)
...
# 设置许可证（例如，MIT 许可证）
usethis::use_mit_license(copyright_holder = "Liu Yan") # 替换为您的姓名
...
# 添加生命周期徽章，指示包的开发阶段
usethis::use_lifecycle_badge(stage = "experimental") # "experimental", "stable" 等
