...
[![Codecov test coverage](https://codecov.io/gh/sgdscixh/bioranger/graph/badge.svg)](https://app.codecov.io/gh/sgdscixh/bioranger)
<!-- badges: end -->
...
You can install the development version of bioranger from [GitHub](https://github.com/) with:
